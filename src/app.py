    ...
    while step < MAX_ITERATIONS:
        ...
        if llm_response.get("type") == "tool_call":
            ...
            conversation = (
                ...
                f"Tool Observation:\n"
                f"{json.dumps(observation, ensure_ascii=False)}\n\n"
                f"Continue reasoning toward the user's goal."
            )
...
if __name__ == "__main__":
    ...
    if "--interactive" in sys.argv:
        ...
        print("   - Câu hỏi chung: 'Cocktail và Mocktail khác nhau như thế nào?'")
        print("   - Tra cứu công thức: 'Hãy tra cứu công thức pha chế Margarita'")
        print("   - Đa bước (Multi-step): 'Tìm Margarita và lưu vào danh sách yêu thích.'")
        ...
        sample_query = "Tìm Margarita và lưu vào danh sách yêu thích."
        print(f"--- 🏁 DEMO CHẠY THỬ 1 TEST CASE RE-ACT ĐA BƯỚC (Multi-step Reasoning) ---")
